...
?>    
    	<tr>
            ...
            <td align="center"><a href="groupedit.php<?php echo "?id=".$row['group_id']; ?>">编辑</a></td>
            <td align="center"><a href="groupdelete.php<?php echo "?id=".$row['group_id']; ?>">删除</a></td>
        </tr>
<?php
	}
}
...
?>
        <tr>
            ...
            onclick="location='groupnew.html'" class="button"></td>
        </tr>
    </table> 
    </div>  
</div>  
