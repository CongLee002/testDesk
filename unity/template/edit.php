...
$id= $_GET['id'];
$select=mysql_query("select * from theater where theater_id = $id") or die(mysql_error());
...
<div id="container">
    ...
    <table align="center" style="margin-left:0px;">
        <tr>
            ...
            <td width="80px" align="center"><a href="theater1.php">剧场信息</td>
    ...
    <hr align="center" width="60%" />
<form action="edit_ok.php" method="post" name="editinfo" id="form1">
